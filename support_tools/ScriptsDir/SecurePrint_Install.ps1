$printServer = "api-eq-unips"
$printerName = "API_SecurePrint"
...
$textNetwork = " Device must be on the API network, does not work via Azure VPN.".PadRight($textTesting.Length,' ')
