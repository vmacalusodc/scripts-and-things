...
# * Added better descriptions to Backup locations
# Vincent Macaluso (R3)
...
$drives = @(
    @{ Letter = "G:"; Name = "Quality"; Path = "\\eq-fs01.api.int\Hercules\Home\Quality" },
    @{ Letter = "I:"; Name = "ES_PDF_Files"; Path = "\\eq-fs01.api.int\hercules\ES_PDF_Files" },
    @{ Letter = "J:"; Name = "Standards_Word"; Path = "\\eq-fs01.api.int\Standards_Word" },
    @{ Letter = "K:"; Name = "ecit"; Path = "\\eq-fs01.api.int\ecit" },
    @{ Letter = "K:"; Name = "Finance"; Path = "\\eq-fs01.api.int\Hercules\Finance\FINANCE" },
    @{ Letter = "L:"; Name = "Publish"; Path = "\\eq-fs01.api.int\hercules\shared\Publish" },
    @{ Letter = "N:"; Name = "Auditorfilecert"; Path = "\\eq-fs01.api.int\hercules\Auditorfilescert" },
    @{ Letter = "O:"; Name = "EOLCS"; Path = "\\eq-fs01.api.int\EOLCS" },
    @{ Letter = "P:"; Name = "ICP"; Path = "\\eq-fs01.api.int\ICP" },
    @{ Letter = "S:"; Name = "Shared"; Path = "\\eq-fs01.api.int\hercules\Shared" },
    @{ Letter = "T:"; Name = "IT"; Path = "\\AZ-IT01\IT" },
    @{ Letter = "U:"; Name = "Statistics"; Path = "\\EQ-FS01.api.int\Departments\Regulatory and Economic Policy\Statistics" },
    @{ Letter = "V:"; Name = "Departments"; Path = "\\eq-fs01.api.int\Departments" },
    @{ Letter = "X:"; Name = "Installs"; Path = "\\AZ-IT01\installs" },
    @{ Letter = "Y:"; Name = "WSBUploads"; Path = "\\az-wsbupload.api.int\wsbuploads" },
    @{ Letter = "Z:"; Name = "SAS Projects"; Path = "\\API-EQ-SAS\SAS Projects" }
)
